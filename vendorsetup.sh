...
git clone --depth=1 https://github.com/mnrniloy/device_oneplus_sm8150-common.git -b 14-B device/oneplus/sm8150-common
echo ""

echo "Cloning kernel tree"
git clone --depth=1 https://github.com/mnrniloy/Neptune_kernel_oneplus_sm8150.git -b inline-erofs kernel/oneplus/sm8150
echo ""
